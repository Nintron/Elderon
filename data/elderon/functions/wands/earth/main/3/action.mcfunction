...
execute as @e[type=!#elderon:ray/ignore_entities,distance=..1.6,sort=nearest,limit=1] unless score @s eUUID = @e[type=area_effect_cloud,tag=earthRay3,sort=nearest,limit=1] eUUID run function elderon:wands/earth/main/3/effects
...
execute if entity @s run schedule function elderon:wands/earth/main/3/schedule 1t append