...
execute as @e[type=!#elderon:ray/ignore_entities,distance=..1.9,sort=nearest,limit=1] unless score @s eUUID = @e[type=area_effect_cloud,tag=earthRay10,sort=nearest,limit=1] eUUID run function elderon:wands/earth/main/10/effects
...
execute if entity @s run schedule function elderon:wands/earth/main/10/schedule 1t append