...
execute as @e[type=!#elderon:ray/ignore_entities,distance=..1.8,sort=nearest,limit=1] unless score @s eUUID = @e[type=area_effect_cloud,tag=earthRay8,sort=nearest,limit=1] eUUID run function elderon:wands/earth/main/8/effects
...
execute if entity @s run schedule function elderon:wands/earth/main/8/schedule 1t append